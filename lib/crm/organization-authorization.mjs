...
export const PERMISSIONS = Object.freeze([
  ...
  "asset.self.manage", "asset.assigned.read", "asset.assigned.review", "asset.deletion.manage",
  ...
  "administrator.nominate", "settings.manage", "security.emergency_remove", "audit.read",
]);
...
const GLOBAL_ROLE_PERMISSIONS = Object.freeze({
  ...
  contributor: ["draft.self.manage", "asset.self.manage"],
  reviewer: ["review.assigned.read", "review.assigned.comment", "asset.assigned.read"],
  editorial_manager: ["editorial.assign", "editorial.completeness.review", "editorial.provenance.verify", "editorial.rights.verify", "editorial.consent.verify", "editorial.ordinary.approve", "editorial.ordinary.publish", "asset.assigned.read", "asset.assigned.review"],
  memory_archives_referent: ["review.assigned.read", "editorial.provenance.verify", "editorial.rights.verify", "editorial.consent.verify", "asset.assigned.read", "asset.assigned.review"],
  community_manager: ["member.approve", "member.suspend", "profile.assigned.read"],
  administrator: ["member.approve", "member.suspend", "profile.assigned.read", "organization.create", "organization.list", "organization.status.manage", "organization.verify", "organization.member.manage", "role.local.manage", "role.global.manage", "settings.manage", "asset.deletion.manage", "audit.read"],
...
const MEMBERSHIP_TRANSITIONS = Object.freeze({ invited: ["active", "revoked"], active: ["suspended", "revoked"], suspended: ["active", "revoked"], revoked: ["invited", "active"] });
