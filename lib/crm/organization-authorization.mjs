...
export const PERMISSIONS = Object.freeze([
  ...
  "editorial.ordinary.publish", "member.approve", "member.suspend",
...
const GLOBAL_ROLE_PERMISSIONS = Object.freeze({
  ...
  editorial_manager: ["editorial.assign", "editorial.ordinary.publish"],
  memory_archives_referent: ["review.assigned.read"],
  community_manager: ["member.approve", "member.suspend", "profile.assigned.read"],
  administrator: ["organization.verify", "role.local.manage", "role.global.manage", "settings.manage"],
