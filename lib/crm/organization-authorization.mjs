...
const GLOBAL_ROLE_PERMISSIONS = Object.freeze({
  ...
  administrator: ["organization.create", "organization.list", "organization.status.manage", "organization.verify", "organization.member.manage", "role.local.manage", "role.global.manage", "settings.manage", "asset.deletion.manage", "audit.read"],
