...
export function createStagingPolicy(env,{activateRemote=false}={}){
  ...
  return Object.freeze({appEnv:"staging",projectId,storageBucket:env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET,region:STAGING_REGION,canonicalUrl:STAGING_CANONICAL_ORIGIN,hosts:Object.freeze(new Set([STAGING_CANONICAL_HOST])),origins:Object.freeze(new Set([STAGING_CANONICAL_ORIGIN])),emulated:false,cookie:Object.freeze({name:"__Host-aitmesbah_session_staging",httpOnly:true,secure:true,sameSite:"strict",path:"/",maxAge:43200}),csrfCookie:Object.freeze({name:"__Host-aitmesbah_csrf_staging",httpOnly:true,secure:true,sameSite:"strict",path:"/",maxAge:600}),appCheck:"observe",rateLimit:Object.freeze({distributedRequired:true,configured:false,productive:false}),remoteInitializationAllowed:false});
}
