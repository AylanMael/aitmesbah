...
const originals: ArchiveCard[] = [
  ...
  { id: "potiere-haouili-1990", type: "Photographies", title: "La peinture des engobes sur une jarre (Années 90)", date: "Début des années 1990", source: "Association Culturelle Imache Amar d’Aït Mesbah", summary: "Application minutieuse des motifs à l’engobe rouge sur une jarre en terre cuite à l’apogée de l’association (potière identifiée : Mme Haouili).", href: "/histoire-memoire/archives/potiere-haouili-1990", image: "/archives/poterie-1990/madame-haouili-potiere-1990.jpg", alt: "Travail de peinture d'engobes sur une jarre en céramique" },
  { id: "madame-guernine-1990", type: "Photographies", title: "Autour des récipients et de l’Akufi (Années 90)", date: "Début des années 1990", source: "Association Culturelle Imache Amar d’Aït Mesbah", summary: "Présentation en tenue traditionnelle auprès d’un grand Akufi peint et de pichets artisanaux du village (personne identifiée : Mme Guernine).", href: "/histoire-memoire/archives/madame-guernine-1990", image: "/archives/poterie-1990/madame-guernine-poterie-1990.jpg", alt: "Présentation de grands récipients en poterie et Akufi traditionnel" },
];
