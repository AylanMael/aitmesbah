...
const comparisons: HeritageComparison[] = [
  {
    id: "tajmaat",
    title: "La Place Tajmaât d'Aït Salah",
    location: "Haut du Village",
    periodBefore: "Années 1970 (Passage dégradé)",
    periodAfter: "2026 (Restauration Pierres & Assises)",
    beforeImg: "/images/amar-imache/maison-natale.jpg",
    afterImg: "/ait-mesbah-village.jpg",
    description: "Restauration complète de la place de l'Assemblée avec dallage en pierre locale, banquette d'assise traditionnelle et consolidation des murs d'enceinte.",
    details: [
      "Assises en pierre sèche taillées main",
      "Restauration de la voûte d'entrée",
      "Éclairage nocturne solaire intégré",
    ],
  },
  {
    id: "fontaine",
    title: "La Fontaine Alma Ath Amrane",
    location: "Quartier Bas",
    periodBefore: "1939 (Cliché Thérèse Rivière)",
    periodAfter: "Aménagement Paysager 2026",
    beforeImg: "/archives/poterie-1939/14.jpg",
    afterImg: "/images/jcam-jeunes-taqaats.jpg",
    description: "Remise en valeur de la source historique avec aménagement d'un bassin d'eau pure, canal de ruissellement et pavage pour protéger la mémoire du lieu.",
    details: [
      "Nettoyage du cours d'eau originel",
      "Création de marches d'accès sécurisées",
      "Plaque mémorielle et pédagogique",
    ],
  },
  {
    id: "ruelles",
    title: "Sentier & Ruelles d'Aït Moussa",
    location: "Quartier Sud",
    periodBefore: "Tracé de terre battue érodé",
    periodAfter: "Pavage traditionnel et murets",
    beforeImg: "/images/amar-imache/portrait-ancien.jpg",
    afterImg: "/images/asam-2026-finaliste.jpg",
    description: "Consolidation des sentiers pierreux contre l'érosion pluviale, plantation d'oliviers d'ombrage et canalisation naturelle des eaux de pluie.",
    details: [
      "Canaux d'évacuation de la pluie",
      "Reboisement des accotements",
      "Consolidation de la falaise d'accès",
    ],
  },
];
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-[#ffffff15] pb-6">
        <div>
          <span className="bg-[#e9c982] text-[#08281f] text-[10px] font-bold uppercase tracking-widest px-3 py-1 rounded-full mb-2 inline-block">
            🏛️ Mémoire & Transformation
          </span>
          <h3 className="font-serif text-2xl md:text-3xl text-white font-bold">
            Conservatoire Visuel Avant / Après Rénovation
          </h3>
          <p className="text-xs text-[#c8d6d0]">
            Observez la renaissance des espaces collectifs d&apos;Aït Mesbah grâce aux travaux Tiwizi.
          </p>
        </div>
