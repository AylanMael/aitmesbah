...
export const villageDistricts: readonly VillageDistrict[] = [
  ...
  },
  {
    ...
    index: "06",
    situation: "Versant d'Oussamar · Nouvelles bâtisses",
    note: "Quartier récent d'Aït Mesbah situé le long du versant ensoleillé d'Oussamar, caractérisé par de nouvelles habitations et bâtisses.",
    landmarks: [
      "Versant d'Oussamar",
      "Nouvelles bâtisses",
    ],
  ...
  },
  {
    ...
    name: "Ighil Oussamar",
    index: "08",
    situation: "Route vers Ath Zmenzer · Équipements & Huileries",
    note: "Quartier récent formé le long de la route reliant le village à Ath Zmenzer. On y trouve le CEM (Collège d'enseignement moyen), des huileries et de nouvelles bâtisses.",
    landmarks: [
      "CEM (Collège d'enseignement moyen)",
      "Huileries",
      "Nouvelles bâtisses",
      "Route reliant le village à Ath Zmenzer",
    ],
  },
  {
    slug: "ighil-hamou",
