...
export const metadata: Metadata = {
  ...
  description: "Un dossier documentaire consacré à Amar Imache, né à Aït Mesbah : parcours militant, pensée politique, écrits, archives et héritage.",
  alternates: { canonical: "/amar-imache" },
};

const chronology = [
  ["1895", "Naître à Aït Mesbah", "Amar Imache naît le 7 juillet 1895 à Aït Mesbah. Son enfance et sa première instruction s’inscrivent dans le territoire des Aït Douala."],
  ["1910", "Élève à Taguemount Oukerrouche", "Après avoir étudié à l’école indigène de Taguemount Oukerrouche, Amar Imache réussit en 1910 l’examen du certificat d’études spécial aux écoles d’indigènes. Le Petit Kabyle du 9 juillet publie son nom parmi les lauréats, aux côtés de quatre autres lauréats d’Aït Mesbah : Guernine, Halès, Hemdani et Haouili — transcrit « Houili » dans le journal."],
  ["1911–1923", "Du pays à la condition ouvrière", "Après une première expérience de travail en Algérie, il gagne la France. Son parcours le conduit dans l’industrie puis dans les mines, au contact direct de la condition des travailleurs nord-africains."],
...
const writings = [
  ...
  ["1946", "L’Heure de l’élite", "Une interpellation sur la responsabilité politique, la conduite collective et l’avenir du pays."],
  ["1947", "Lettre d’adieu aux Algériens résidant en France", "Un texte de rupture et de vigilance politique, diffusé sous forme de feuille volante."],
  ["1934–1936", "Articles dans El Ouma", "Une constellation de textes sur le droit des peuples, la répression, l’impérialisme, l’exil et le statut colonial."],
] as const;

const archiveFamilies = [
  ["Papiers personnels", "Correspondances, carnets, manuscrits, documents d’identité, photographies et souvenirs conservés par la famille."],
  ["Presse militante", "Numéros d’El Ouma, articles signés, tracts, affiches, circulaires et comptes rendus de réunions."],
  ["Écrits politiques", "Éditions originales, rééditions, annotations, épreuves et traductions de ses brochures."],
  ["Archives publiques", "Dossiers de surveillance, procédures judiciaires, détention, travail, circulation et correspondance administrative."],
  ["Mémoire orale", "Témoignages familiaux, récits des anciens du village, souvenirs de militants et transmissions intergénérationnelles."],
  ["Réception et héritage", "Livres, recherches universitaires, documentaires, hommages, conférences, plaques et lieux portant son nom."],
] as const;
