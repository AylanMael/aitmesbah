...
| 8C — Authentification | Comptes, connexion/déconnexion, sessions, protection serveur, refus ; architecture 8B2 validée et commitée | Authentification et contrôles serveur ; fichiers à déterminer | Fournisseur, récupération, session, MFA ; aucun rôle métier implicite | Refus par défaut, révocation, tests positifs/négatifs ; dépend de la validation et du commit de 8B2 |
