...
| 8D — Authentification et cycle des comptes | Invitation, activation, suspension, réactivation, révocation et audit local | Identité locale, profil métier, contrôles serveur et règles ; fichiers autorisés par la mission | Aucun libre-service, rôle implicite, compte réel ou accès distant | Transitions, refus client et audit testés ; dépend de la validation et du commit de 8C |
