...
before(async () => {
  ...
  await environment.withSecurityRulesDisabled(async (context) => {
    ...
    await setDoc(doc(database, "crmActivations", "activation-fixture"), { uid: "active-user", state: "password_pending" });
  });
});
